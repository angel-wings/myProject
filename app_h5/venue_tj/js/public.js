// var indexDomain = 'http://pre.tongji.h5.iydsj.com';//187
// var domain = "http://pre.venue.gxapp.iydsj.com";//187
// var indexDomain = "http://test.tongji.venue.iydsj.com";
// var domain = 'http://test.venue.gxapp.iydsj.com';
var indexDomain = 'https://tongji.userinfo.iydsj.com'; //线上
var domain = "https://venue.gxapp.iydsj.com"; //线上
...
function isThirdPartyPage() {
    window.WebViewJavascriptBridge.callHandler(
        'isThirdPartyPage', { "isThirdPartyPage": false },
        function(responseData) {
            //do nothing;
        })
}
...
function setTokenAndUnid(token, unid) {
    if (token && unid) {
        removeStore("token");
        removeStore("unid");
        removeStore("phone");
