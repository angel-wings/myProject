$(function () {
    ...
    var vm = new Vue({
        ...
        mounted: function () {
            ...
            //         test: [    //  体测成绩列表
            //             { "type": 1, "score": 8000, "value1": 1976, "value2": 76600, "extraScore": 0, "level": 2, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 2, "score": 0, "value1": 227, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 3, "score": -99999, "value1": 4150, "value2": 0, "extraScore": 0, "level": 1, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 5, "score": 3000, "value1": 0, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 13, "score": 7600, "value1": 107, "value2": 0, "extraScore": 0, "level": 3, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 6, "score": 0, "value1": 2, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 0, "score": 5320, "value1": 0, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": 0, averageScore: 60 }
            //         ]
            //     },
            //     {
            //         name: '莉莉',
            //         studentCode: 6432486131,
            //         gender: 0,
            //         grade: 5,
            //         classTotalPeople: 49,     // 班级总人数
            //         classRank: 2,            // 班级排名位置
            //         gradeRankingRadio: 58,    // 年级排名的百分比的分子数
            //         test: [    //  体测成绩列表
            //             { "type": 1, "score": 8000, "value1": 1976, "value2": 76600, "extraScore": 0, "level": 2, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 2, "score": 1000, "value1": 227, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 3, "score": -99999, "value1": 4150, "value2": 0, "extraScore": 0, "level": 1, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 5, "score": 3000, "value1": 0, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 13, "score": 7600, "value1": 107, "value2": 0, "extraScore": 0, "level": 3, "totalScoreStatus": -99999, averageScore: 60 },
            //             { "type": 6, "score": 0, "value1": 2, "value2": 0, "extraScore": 0, "level": 4, "totalScoreStatus": -99999, averageScore: 60 },
            ...
            // this.physicalTest = this.physicalScoreFormat(data[0].test);
            // this.studentInfoFormat(data[0]);
            // this.toCanvas('rank-rate', data[0].gradeRankingRadio, 100);
            // this.lowerHtml = this.textMessageFormat(data[0].test).lowerHtml;
            // this.suggestTest = this.textMessageFormat(data[0].test).suggestTest;
        ...
        methods: {
            ...
            getInfoInsertHtml: function (list) {
                ...
                this.physicalTest = this.physicalScoreFormat(list.test);
                this.toCanvas('rank-rate', list.gradeRankingRadio, 100);
                this.lowerHtml = this.textMessageFormat(list.test).lowerHtml;
                this.suggestTest = this.textMessageFormat(list.test).suggestTest;
            },
            ...
            getCode: function () {
                ...
                if (code == null || code == "") {
                    ...
                    // 获取openID
                    this.getOpenIdByOwnInterface(code);
                }
            },

            //////////////////////////////////////////////////////////////////////////////////
            // 自定义接口根据code获取openid
            getOpenIdByOwnInterface: function (code) {
                var that = this;
                alert('getOpenIdByOwnInterface');
                $.ajax({
                    type: 'GET',
            ...
            getScoreDetail: function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        alert('成绩获取成功：' + JSON.stringify(data));
            ...
            studentInfoFormat: function (scoreList) {
                ...
                var list = this.physicalScoreFormat(scoreList.test);
